...
let favColors = ['blue', 'green', 'black'];
...
favColors.push({ greeting: "Hi ik ben een object" });
console.log(favColors[favColors.length - 1].greeting);
...
console.log('favourite_food cat 3:', catBreeds[2].food.favourite_food);